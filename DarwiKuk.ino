...
//    =======================================================
//
//    DarwiKuk 2.3_9 2018-11-29
int ver = 9;
//      * nově zpracovává možné připojení čidla vlhkosti půdy
//      * vypíná napájení čidel, pokud jsou meteorologická zapojené na PIN D6 a vlhkost půdy na D7
